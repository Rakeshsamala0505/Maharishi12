...
import { ReactComponent as WorldSVG } from '../assets/world_map_clea.svg';
...
AR: { name: 'Argentina', millets: 'Proso or Common millet, Sorghum', institutions: ['National Agricultural Technology Institute (INTA)','National University of Cordoba'] },
  ...
  TR: { name: 'Turkey', millets: 'Local Varieties of Sorghum (Vulgare, Sand, Djin)', institutions: ['NILL'] },
  US: { name: 'USA', millets: 'Sorghum, Kodo Millet, Amarnath, Farro, Teff, Buckwheat, Spelt', institutions: ['Sorghum United','North American Millets Alliance (NAMA)'] },
  ...
  TD: { name: 'Chad', millets: 'Sorghum', institutions: ['  Lake Chad Research Institute',' Swiss Agency for Development and Cooperation (SDC)','Agence Française de Development (AFD)'] },
  ...
  GN: { name: 'Guinea', millets: 'Pearl Millet,Foxtail Millet,Kodo Millet,Finger Millet,Sorghum Millet', institutions: ['ICRISAT'] },
  ...
  KE: { name: 'Kenya', millets: 'Pearl Millet,Foxtail Millet,Common Millet,Finger Millet', institutions: ['International Crops Research Institute for the Semi-Arid Tropics (ICRISAT)'] },
