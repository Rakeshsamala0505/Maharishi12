...
const OrganisationChart = () => {
  return (
    <div className={styles.orgWrapper}>
      <h2 className={styles.orgTitle}>CHARTER FLOW Chart</h2>
      ...
      <div className={styles.chartContainer}>
        <div className={styles.chartContent}>
          ...
          <div className={styles.box} style={{ top: '30px', left: '750px' }}>
          ...
          <div className={`${styles.box} ${styles.secretariat}`} style={{ top: '250px', left: '750px' }}>
          ...
          <svg
             ...
             {/* Top to Mid */}
             <path d="M150 100 V270 A10 10 0 0 0 160 280 H220" stroke="#999" strokeWidth="2" fill="none" />
             <path d="M500 100 V270 A10 10 0 0 1 490 280 H420" stroke="#999" strokeWidth="2" fill="none" />
             <line x1="850" y1="121" x2="850" y2="250" stroke="#999" strokeWidth="2" />
             ...
             <line x1="750" y1="80" x2="600" y2="80" stroke="#999" strokeWidth="2" />
