...
import useAnimateOnView from "../pages/useAnimateOnView";
...
const Home = () => {
  ...
  const [currentAnnouncementIndex, setCurrentAnnouncementIndex] = useState(0);
    const { ref: leaderRef, visible: leaderVisible } = useAnimateOnView(0.5);
    const { ref: highlightsRef, visible: highlightsVisible } = useAnimateOnView(0.5);
  ...
  return (
    <div className="home-container">
      ...
      {/* Leader Messages */}
       <section
         ref={leaderRef}
         className={`section-container ${leaderVisible ? "animate" : ""}`}
       >
        {[ {
          img: PM,
...
<           div className="card fade-up" key={idx}>
      ...
      {/* Highlights Section */}
       <section
         id="latest-updates"
         ref={highlightsRef}
         className={`py-5 highlights-section ${highlightsVisible ? "animate" : ""}`}
       >
         ...
         <div className="container">
           ...
           <div className="row">
             {[
               ...
               <div
                 className="col-md-4 mb-2 fade-left"
     ...
     <div className="relative z-10 w-full px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 text-center">
          ...
          <div className="flex flex-col items-center h-full gap-0">
            <h2 className="text-3xl md:text-4xl font-bold text-[#FFFFFFF] mb-4">
              NEWSLETTER
            </h2>
            ...
            <a
              href="newsletter.js"
              className="learn-more-btn mt-auto"
              >
              Learn More
            </a>
